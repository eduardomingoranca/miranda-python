# Exercicio solucionado: calculando as datas e parcelas de um emprestimo
# Mary pegou um emprestimo de 1.000.000
# para realizar o pagamento em 5 anos.
# A data em que ela pegou o emprestimo foi
# 20/12/2020 e o vencimento de cada parcela
# eh no dia 20 de cada mes.
...
print()
print(
    f'Voce pegou R$ {valor_total:,.2f} para pagar '
