...
# Eh um formato de arquivo que armazena dados em forma de tabela, onde cada
# linha representa uma linha da tabela e as colunas sao separadas por virgulas.
# Ele eh amplamente utilizado para transferir dados entre sistemas de diferentes
...
# Um arquivo CSV geralmente tem a extensao ".csv" e pode ser aberto em um
...
# 3 - Nao deixar linhas ou espacos sobrando
