...
# Filas (queue)
# Significa que o primeiro item a entrar sera o primeiro a sair (deque)
# Artigo:
...
fila_correta.appendleft(2)  # Adiciona no comeco
fila_correta.appendleft(1)  # Adiciona no comeco
fila_correta.appendleft(0)  # Adiciona no comeco
