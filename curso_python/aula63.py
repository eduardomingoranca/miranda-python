...
for digito in nove_digitos:
    resultado_digito_1 = resultado_digito_1 + int(digito) * contador_regressivo_1
    contador_regressivo_1 = contador_regressivo_1 - 1
...
for digito in dez_digitos:
    resultado_digito_2 = resultado_digito_2 + int(digito) * contador_regressivo_2
    contador_regressivo_2 = contador_regressivo_2 - 1
...
if cpf_enviado_usuario == cpf_gerado_pelo_calculo:
    print(f'{cpf_enviado_usuario} eh valido')
else:
    print('CPF invalido')