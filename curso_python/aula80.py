...
numero como a duplicacao. Retorne a duplicacao considerada.
Requisitos:
    A ordem do numero duplicado eh considerada a partir da segunda
    ocorrencia do numero, ou seja, o numero duplicado em si.
    Exemplo:
        [1, 2, 3, ->3<-, 2, 1] -> 1, 2 e 3 sao duplicados (retorne 3)
